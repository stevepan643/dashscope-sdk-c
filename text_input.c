 ...
 * Text Input Example
 * 
 * Demonstrates basic text generation with the DashScope API.
 * This example sends a simple text query to the Qwen Plus model
...
int main(int argc, char **argv)
{
	...
	DS_Content user_input = ds_content_text("What is the meaning of life?");
