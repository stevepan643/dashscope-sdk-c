 ...
 * Video Input Example
 * 
 * Demonstrates video analysis with the DashScope API.
 * This example sends video frames as a sequence of images
 * to the Qwen VL Plus model for content analysis.
 */
...
int main(int argc, char **argv)
{
	...
	DS_Content user_contents[] = {
		ds_content_text("Please analyze this video:"),
		ds_content_video(video_frames, 4)
	};
